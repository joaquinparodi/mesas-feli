      ...
      <div className="flex items-center gap-3 border-b border-white/10 p-5">
        ...
        {!collapsed && (
          <div>
            ...
            <p className="text-[10px] text-white/40">Panel de Control</p>
          </div>
        )}
      </div>
            ...
            return (
              <Link
                ...
                className={`
                  ...
                  ${
                    active
                      ? 'bg-purple-600/20 text-purple-400 neon-glow'
      ...
      >
        ...
        <div className="sticky top-0 z-30 flex items-center gap-3 border-b border-white/10 bg-[#0a0a1a]/90 px-4 py-3 backdrop-blur-lg lg:hidden">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-bold text-white/80">MesaVIP</span>
          </div>
        </div>
